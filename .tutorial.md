...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-dataproc-composer.sh` on the terminal.
...
This asset enables you to launch Dataproc jobs with Cloud Composer.
...
This asset enables you to perform the following activities:
 ...
 - Create GKE cluster
 - Prepare for Apigee installation
 - Install Apigee
 - Create API proxy
